...
#ifndef MY_SCHEDULER_CHECK_SCHEDULE_HPP
#define MY_SCHEDULER_CHECK_SCHEDULE_HPP
...
namespace alps {
    ...
    public:
        ...
        my_check_schedule(double tmin=10., double tmax=20.)
        :   min_check_(tmin)
        ,   max_check_(tmax)
        {
        }
        ...
        void update(double fraction, bool verbose)
        {
            time_point now = clock::now();
            ...
            if (verbose) {
                std::cout << "Fraction is " << fraction << ". Next check will be in " << next_check_ << "." << std::endl;
            }
...
#endif // !defined MY_SCHEDULER_CHECK_SCHEDULE_HPP
